 ...
 *         &lt;element name="data" type="{http://www.iVend.com/IIntegrationService/2010/12}PostTransaction" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "X_SaveTransaction")
public class XSaveTransaction {
    ...
    @XmlElementRef(name = "data", namespace = "http://www.iVend.com/IIntegrationService/2010/12", type = JAXBElement.class, required = false)
    protected JAXBElement<PostTransaction> data;
     ...
     *     
     */
    public JAXBElement<PostTransaction> getData() {
        return data;
    }
     ...
     *     
     */
    public void setData(JAXBElement<PostTransaction> value) {
        this.data = value;
    }
