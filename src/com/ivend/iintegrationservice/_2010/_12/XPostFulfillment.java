 ...
 *         &lt;element name="data" type="{http://www.iVend.com/IIntegrationService/2010/12}PostDelivery" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "X_PostFulfillment")
public class XPostFulfillment {
    ...
    protected JAXBElement<PostDelivery> data;
     ...
     *     
     */
    public JAXBElement<PostDelivery> getData() {
        return data;
    }
     ...
     *     
     */
    public void setData(JAXBElement<PostDelivery> value) {
        this.data = value;
    }
