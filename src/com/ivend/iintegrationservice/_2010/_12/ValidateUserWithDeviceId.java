...
@XmlRootElement(name = "ValidateUserWithDeviceId")
public class ValidateUserWithDeviceId {
    ...
    @XmlElementRef(name = "DeviceName", namespace = "http://www.iVend.com/IIntegrationService/2010/12", type = JAXBElement.class, required = false)
