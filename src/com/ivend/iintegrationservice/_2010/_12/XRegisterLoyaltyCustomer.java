 ...
 *         &lt;element name="data" type="{http://www.iVend.com/IIntegrationService/2010/12}Customer" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "X_RegisterLoyaltyCustomer")
public class XRegisterLoyaltyCustomer {
    ...
    protected JAXBElement<Customer> data;
     ...
     *     
     */
    public JAXBElement<Customer> getData() {
        return data;
    }
     ...
     *     
     */
    public void setData(JAXBElement<Customer> value) {
        this.data = value;
    }
