 ...
 *         &lt;element name="data" type="{http://www.iVend.com/IIntegrationService/2010/12}AuthorizePaymentRequest" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "X_AuthorizePayment")
public class XAuthorizePayment {
    ...
    protected JAXBElement<AuthorizePaymentRequest> data;
     ...
     *     
     */
    public JAXBElement<AuthorizePaymentRequest> getData() {
        return data;
    }
     ...
     *     
     */
    public void setData(JAXBElement<AuthorizePaymentRequest> value) {
        this.data = value;
    }
