...
@XmlRootElement(name = "CancelSalesOrder")
public class CancelSalesOrder {
    ...
    @XmlElementRef(name = "transactionKey", namespace = "http://www.iVend.com/IIntegrationService/2010/12", type = JAXBElement.class, required = false)
