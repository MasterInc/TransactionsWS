...
@XmlRootElement(name = "DeleteState")
public class DeleteState {
    ...
    @XmlElementRef(name = "countryId", namespace = "http://www.iVend.com/IIntegrationService/2010/12", type = JAXBElement.class, required = false)
