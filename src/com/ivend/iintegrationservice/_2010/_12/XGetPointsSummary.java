...
@XmlRootElement(name = "X_GetPointsSummary")
public class XGetPointsSummary {
    ...
    @XmlElementRef(name = "CustomerLoyaltyId", namespace = "http://www.iVend.com/IIntegrationService/2010/12", type = JAXBElement.class, required = false)
    protected JAXBElement<String> customerLoyaltyId;
     ...
     *     
     */
    public JAXBElement<String> getCustomerLoyaltyId() {
     ...
     *     
     */
    public void setCustomerLoyaltyId(JAXBElement<String> value) {
